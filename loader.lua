...
N['8'].Position = UDim2.new(0, 50, 0.5, 0)
...
local function ShowStatus(message)
	...
	task.spawn(function()
		...
		TweenService:Create(N['2'], notificationSettings, {Size = UDim2.new(0, 100 + 16 + messageBounds, 0, 40)}):Play()
		TweenService:Create(N['4'], notificationSettings, {Rotation = -360, Size = UDim2.new(0, 40, 0, 40)}):Play()
		...
		TweenService:Create(N['4'], notificationSettings, {Rotation = 0, Size = UDim2.new(1, 0, 1, 0)}):Play()
